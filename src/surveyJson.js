      ...
      elements: [
        {
          ...
          choices: [
            ...
            { value: 'muscule-building', text: 'Muscle Building', description: 'Your journey should be more about gaining muscle' },
            { value: 'flexibility', text: 'Flexibility', description: 'Your journey should be more about flexibility' },
            { value: 'endurance-training', text: 'Endurance Training', description: 'Your journey should be more about endurance' },
            { value: 'being-healthier', text: 'Being Healthier', description: 'Your journey should be more about being healthier' },
          ],
        },
      ],
    },
